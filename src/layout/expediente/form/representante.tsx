...
export function ExpedienteRepresentante({
  values,
  errors,
  handleChange,
  setFieldValue,
          ...
          ? values.infoRepresentantes.map((representative: any, index: number) => {
              ...
              return (
                ...
                >
                  <Grid sm={1} md={2} lg={2} gap={3}>
                    ...
                    >
                      <InputText
                        ...
                        style={{width:canFulfillment === true ?'75%' :'100%', height:42, borderRadius: 6}}
                      />
                    </FormItem>
                    ...
                    <Grid sm={1} md={2} lg={2} gap={3} className="flex items-end">  
                      <FormItem
                      ...
                      >
                        <InputText
                          ...
                          placeholder={`Número de registro del representante ${representanteNumber}`}
                          onChange={handleChange}
                          disabled={Boolean(
                            activeTab == 99
                              ? fulfillment[
                  ...
                  <p className="text-[#6A6D74] my-3" >Documentos</p>
