...
const setFieldData = (data: Map<string, FormFieldData<FieldRenderType>>) => {
  data.set("ecommerce", {
    ...
    inputProps: (props) => {
      return {
        icon: "Screen",
        title1: "Pago a",
        title2: "Link de negocio/Link de pago",
        contentClassName: "my-5 bg-[white]",
        checked: !!props.values.ecommerce,
        onChange: (e: any) => {
          props.setFieldValue("ecommerce", toByte(e.checked));
        },
      };
    },
  });
  ...
  data.set(FIELD.MSI, {
    ...
    inputProps: (props) => {
      return {
        ...
        contentClassName: "my-5 bg-[white]",
        checked: !!props.values.ventaLinea.msi,
        onChange: (e: any) => {
          props.setFieldValue("ventaLinea.msi", toByte(e.checked));
  ...
  data.set(FIELD.MSI_3, {
    ...
    inputProps: (props) => {
      return {
        value: undefined,
        checked: !!props.values.ventaLinea.msi3,
        onChange: ({ value }: any) => {
        ...
        disabled: Boolean(props.disabled || !props.values.ventaLinea.msi),
      };
    },
  });
  data.set(FIELD.COMISION_3, {
    ...
    inputProps: (props) => ({
      ...
      disabled: Boolean(
        props.disabled ||
          !props.values.ventaLinea.msi ||
          !props.values.ventaLinea.msi3
      ),
      style: DEFAULT_STYLES,
    }),
  });
  ...
  data.set(FIELD.MSI_6, {
    ...
    inputProps: (props) => ({
      value: undefined,
      checked: !!props.values.ventaLinea.msi6,
      onChange: ({ value }: any) => {
  ...
  data.set(FIELD.MSI_9, {
    ...
    inputProps: (props) => ({
      value: undefined,
      checked: !!props.values.ventaLinea.msi9,
      onChange: ({ value }: any) => {
  ...
  data.set(FIELD.MSI_12, {
    ...
    inputProps: (props) => ({
      value: undefined,
      checked: !!props.values.ventaLinea.msi12,
      onChange: ({ value }: any) => {
  ...
  data.set(FIELD.MSI_18, {
    ...
    inputProps: (props) => ({
      value: undefined,
      checked: !!props.values.ventaLinea.msi18,
      onChange: ({ value }: any) => {
