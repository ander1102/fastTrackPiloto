  ...
  return (
    ...
    >
      <section className="flex flex-col items-center gap-5">
        <img src={"/Images/modal/shop.svg"} />
        <h2 className="text-[#2E3339] text-center text-2xl">
          ¡Pago Recurrente creado con éxito!
        </h2>
        <p className="text-[#2E3339] text-center text-md mb-5">
          El Pago Recurrente ha sido creado de manera exitosa.
        </p>
...
export default withModalPageSize(ModalPaymentCreated);
