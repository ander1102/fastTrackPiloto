...
import modalPaymentRemoved from "./modalQuestionRemovePaymentResponse";

function modalPaymentRemove({
  visibleStyles,
  handleClose,
  show,
      ...
      <section className="flex flex-col items-center gap-5">
        ...
        <div className="flex gap-10">
          ...
          <Button
            ...
            onClick={() => {
                handleClose(false)
                modalManager.show(modalPaymentRemoved)
            }}
          />
        </div>
      </section>
...
export default withModalPageSize(modalPaymentRemove);
